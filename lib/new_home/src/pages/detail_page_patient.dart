...
class DetailPagePatient extends StatefulWidget {
  final PatientModel model;
  const DetailPagePatient({required Key? key, required this.model})
      : super(key: key);

  @override
  _DetailPagePatientState createState() => _DetailPagePatientState();
}

class _DetailPagePatientState extends State<DetailPagePatient> {
